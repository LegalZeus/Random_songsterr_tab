function main() {
    ...
    fetch("http://www.songsterr.com/a/ra/songs.json?pattern=" + artist_name)
        .then(res => res.json())
        .then(res => {
            ...
            let song_link = `http://www.songsterr.com/a/wa/bestMatchForQueryString?s={${song_title}}&a={${artist}}`
